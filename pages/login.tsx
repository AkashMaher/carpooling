  ...
  return (
    ...
    <motion.div
     ...
     <div><p>New User : Create Account</p></div>
        ...
        <div className="h-[35px] relative rounded-lg">
            <select className="outline-none w-30 h-full bg-[#585858] px-[5%] text-white rounded-lg" id="gender" name="gender" onChange={(e) => handleUserInput("gender",e.target.value)}>
    ...
    <main className="p-4 pt-6 lg:px-16 min-h-screen">
        ...
        <div>
            ...
            <div>
                ...
                {!isConnected && <> <br></br> <button onClick={() => handleConnect()}>Connect Wallet</button> </>}
            </div>
