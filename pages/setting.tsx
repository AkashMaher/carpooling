...
const UpdateAccount: FC<{ handleUserInput: (_name:any, _value: any) => void, updateUser:()=> void, deleteUser:()=> void, userInfo:any
  ...
  return (
    ...
    <motion.div
     ...
     <br></br>
        ...
        <div className="h-[35px] relative rounded-lg">
            <select className="outline-none w-30 h-full bg-[#585858] px-[8.9%] text-white rounded-lg" id="gender" name="gender" onChange={(e) => handleUserInput("gender",e.target.value)} defaultValue={userInfo?.gender}>
        ...
        <button className="outline-none mr-4 mt-4 w-30 h-full bg-[#36a909] py-[1%] px-[7.4%] text-white rounded-lg" onClick={()=> updateUser()}>Update Account</button>
        <p>Delete Your Account</p>
        <button className="outline-none mr-4 mt-4 w-30 h-full bg-[#ff1212] py-[1%] px-[7.5%] text-white rounded-lg" onClick={()=> deleteUser()}>Delete Account</button>
        </div>
    </motion.div>
    </>
  )
...
const SettingPage: NextPage = () => {
    ...
    const updateUser = async ()=> {
        ...
        console.log(isUser)
        const updateAccount = await carContract.updateUser(name, age, gender, phone, email, role)
        .then((tx: any) => {
    ...
    const deleteUser = async () => {
        ...
        const deleteAccount = await carContract.deleteUser()
        .then((tx: any) => {
          console.log('processing')
          provider.waitForTransaction(tx.hash).then(()=> {
  ...
  return (
    ...
    <main className="p-4 pt-6 lg:px-16 min-h-screen">
        ...
        <div>
            ...
            {checkIfNewUser && 
                <>
                <UpdateAccount handleUserInput={handleUserInput} updateUser={updateUser} deleteUser={deleteUser} userInfo={userInfo}/>
                </>
            }
        </div>}
    </main>
